...
request = requests.get('https://sebenarnya.my/category/sosial/jenayah/')
...
page_url = 'https://sebenarnya.my/category/sosial/jenayah/'
...
while page_url:
    ...
    for news in main.find_all('a'):
        ...
        for temp in news.find_all('img'):
            ...
            Crime = db.collection("Crime").document(doc_id)
